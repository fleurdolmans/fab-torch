...
from boltzmann_generators_3d.fab.sampling_methods.base import Point
...
class Metropolis(TransitionOperator):
    def __init__(
        ...
        self.register_buffer(
            "noise_scalings",
            torch.linspace(max_step_size, min_step_size, n_updates).repeat((n_ais_intermediate_distributions, 1)),
        )
