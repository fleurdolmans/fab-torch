...
python ${LOGS_DIR}/${PROJECT_NAME}/experiments/solvation/run.py \\
  ...
  flow.hidden_units=128 flow.base.type=structured-gauss flow.base.learn_mean_var=false flow.type=perm-equi-torus-nf\\
  ...
  evaluation.n_eval=10 evaluation.n_plots=5 evaluation.n_checkpoints=1 
EOF
