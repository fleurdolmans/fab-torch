...
import torch
from boltzmann_generators_3d.fab.trainable_distributions import TrainableDistribution
...
class DefensiveMixtureDistribution(TrainableDistribution):
    ...
    def log_prob(self, x: torch.Tensor) -> torch.Tensor:
        ...
        components = torch.stack((log_q_flow + torch.log(mix_flow), log_q_defensive + torch.log(1 - mix_flow)), dim=0)
...
if __name__ == "__main__":
    from boltzmann_generators_3d.experiments.make_flow import make_wrapped_normflow_realnvp
    from boltzmann_generators_3d.fab.utils.plotting import plot_contours, plot_marginal_pair
