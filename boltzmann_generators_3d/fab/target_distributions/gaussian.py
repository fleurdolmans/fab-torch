...
from boltzmann_generators_3d.fab.utils.numerical import (
...
class Gaussian(nn.Module, TargetDistribution):
    def __init__(
        ...
        self.register_buffer(
            "true_expectation",
            MC_estimate_true_expectation(self, self.expectation_function, true_expectation_estimation_n_samples),
        )
    ...
    def distribution(self):
        dist = torch.distributions.MultivariateNormal(self.locs, scale_tril=self.scale_tril, validate_args=False)
        return dist
...
if __name__ == "__main__":
    ...
    from boltzmann_generators_3d.fab.utils.plotting import plot_contours
