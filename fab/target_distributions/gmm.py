...
class GMM(nn.Module, TargetDistribution):
    ...
    def distribution(self):
        ...
        com = torch.distributions.MultivariateNormal(self.locs, scale_tril=self.scale_trils, validate_args=False)
    ...
    def log_prob(self, x: torch.Tensor):
        curr_device = x.device  # Necessary because x is sometimes cpu and sometimes cuda.
        ...
        mask[log_prob < -1e4] = -torch.tensor(float("inf")).to(curr_device)
